...
Функция exch_ВыполнитьВыгрузкуДанных(ОбъектВыгрузки) Экспорт
	...
	Попытка
		...
		ОбменДаннымиXDTOСервер.exch_ПроизвестиВыгрузкуДанных(КомпонентыОбмена);
	Исключение
