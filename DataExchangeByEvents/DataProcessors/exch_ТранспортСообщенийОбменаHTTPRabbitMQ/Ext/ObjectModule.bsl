...
Функция ВыполнитьДействияПередОбработкойСообщения() Экспорт
	...
	Возврат Истина; //СоздатьВременныйКаталогСообщенийОбмена();
...
Процедура Инициализация() Экспорт
	...
	ИмяMQСервера = "172.18.252.73";
	ПортMQСервера = 5672;
	ИмяMQХоста = "/";
	ИмяMQОбменника = "microbus";
	ИмяПользователя = "exchange";
	ПарольПользователя = "123456";
	ИмяОчередиИсходящихСообщений = "microbus2acc";
