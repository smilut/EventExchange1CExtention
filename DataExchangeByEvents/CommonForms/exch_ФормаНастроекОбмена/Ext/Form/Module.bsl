...
Процедура СохранитьНастройки()
	...
	настройки.Узлы.Очистить();	
	Для Каждого стр Из Узлы Цикл
		НастройкиУзла = exch_ОбменДаннымиНастройки.СтруктураНастроекУзла();
		ЗаполнитьЗначенияСвойств(НастройкиУзла, стр);
		
		настройки.Узлы.Вставить(
			стр.Узел, 
			НастройкиУзла
		);
	КонецЦикла;
